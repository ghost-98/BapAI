<template>
  <div class="min-h-screen flex items-center justify-center bg-gray-100">
    <div class="text-center">
      <h1 class="text-2xl font-semibold text-gray-800 mb-4">구글 로그인 처리 중...</h1>
...
onMounted(async () => {
  ...
  sessionStorage.removeItem('google_state'); // Clear social login state
  ...
  try {
    ...
    console.error('구글 로그인 처리 실패:', error.response ? error.response.data : error.message);
